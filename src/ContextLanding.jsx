...
export default function ContextLanding() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-clip text-gray-900 bg-surface">
      ...
      <nav
        className={`safe-area-top fixed top-0 z-50 w-full transition-all duration-300 ${
          scrolled
...
/>
      ...
      <section
        id="top"
        ref={heroRef}
        className="hero-canvas hero-padding relative flex flex-col items-center justify-start min-h-[90vh] px-6 pb-18 lg:px-8 text-center"
      >
